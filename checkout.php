                ...
                <div class="cart">
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <td><?php echo $arr_cart_ssd_capacity[$i]; ?></td>
                            <td><?php echo $arr_cart_ram_capacity[$i]; ?></td>
		                	...
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    <img src="assets/img/esewa.png" alt="esewa" width="150px"/>
                                    ...
                                    <form class="esewa" action="https://uat.esewa.com.np/epay/main" method="post" id="esewa_form" >
										...
										<input value="http://localhost:8080/ShoeIsh/payment/esewa/esewa_payment_success.php" type="hidden" name="su">
										<input value="http://localhost:8080/ShoeIsh/payment/esewa/esewa_payment_failed.php" type="hidden" name="fu">
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn btn-primary" value="Pay With Esewa" name="form1">
                                        </div>
                                    </form>
                                    <form action="payment/bank/init.php" method="post" id="bank_form">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn btn-primary" value="Pay With Bank Deposit" name="form3">
                                        </div>
                                    </form>  
	                            </div>
