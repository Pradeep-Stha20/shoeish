...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
    	...
    	if($_SESSION['user']['photo']!='') {
    		unlink('digi/assets/uploads/'.$_SESSION['user']['photo']);	
    	}

    	// updating the data
    	$final_name = 'user-'.$_SESSION['user']['id'].'.'.$ext;
        move_uploaded_file( $path_tmp, 'digi/assets/uploads/'.$final_name );
								...
								<div class="box-body">
									...
									<div class="form-group">
							            ...
							            <div class="col-sm-6" style="padding-top:6px;">
							                <img src="digi/assets/uploads/<?php echo $photo; ?>" class="existing-photo" width="140">
							            </div>
							        </div>
