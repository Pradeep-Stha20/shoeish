					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							foreach ($result as $row) {
								$i++;
								?>
								<tr class="<?php if($row['p_is_active']==1) {echo 'bg-g';}else {echo 'bg-r';} ?>">
									<td><?php echo $i; ?></td>
									...
									<td>
										...
										<a href="product-change-status.php?id=<?php echo $row['p_id']; ?>" class="btn btn-success btn-xs">Change Status</a>
											<?php  else: ?>
										<a href="product-change-status.php?id=<?php echo $row['p_id']; ?>" class="btn btn-danger btn-xs">Change Status</a>
											<?php endif; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Be careful! This product will be deleted from the order table, payment table, ssd table, ram table and rating table also.</p>
            </div>
