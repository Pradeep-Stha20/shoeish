                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a onclick="return confirmDelete();" href="cart-item-delete.php?id=<?php echo $arr_cart_p_id[$i]; ?>&ssd=<?php echo $arr_cart_ssd_id[$i]; ?>&ram=<?php echo $arr_cart_ram_id[$i]; ?>" class="trash"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php endfor; ?>
                        <tr>
